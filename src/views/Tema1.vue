  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Contenido digital para el <em>marketing</em>

    p.mb-5 Producir contenido digital se ha convertido en uno de los objetivos más importantes para el mundo empresarial teniendo presente que ahora con un click la información llega de forma rápida y oportuna a través de los dispositivos móviles. 
      ...
      .col-lg-11.col-md-12.col-12
        .tarjeta-avatar-b.mb-3
          .tarjeta-avatar-b__img.p-md-3(style="place-content: space-evenly;")
            img(src='@/assets/curso/temas/tema1/img-1.png' class="w-lg-50" alt='')
          .tarjeta.color-secundario--borde
            .p-4
              p <strong>Definir «el perfil de tu público»</strong>
              p.mb-0 Identificar plenamente quién es el público objetivo, para ello se debe caracterizar la comunidad, o crear un perfil de consumidor (<em>buyer</em> persona) para el servicio, producto, o marca.
      .col-lg-11.col-md-12.col-12
        .tarjeta-avatar-b.mb-3
          .tarjeta-avatar-b__img.p-md-3(style="place-content: space-evenly;")
            img(src='@/assets/curso/temas/tema1/img-2.png' class="w-lg-50" alt='')
          .tarjeta.color-secundario--borde
            .p-4
              p <strong>Crear un «mensaje de interés» para el público</strong>
              p.mb-0 El mensaje debe estar enfocado en resolver algún problema de dicho público. 
      .col-lg-11.col-md-12.col-12
        .tarjeta-avatar-b.mb-3
          .tarjeta-avatar-b__img.p-md-3(style="place-content: space-evenly;")
            img(src='@/assets/curso/temas/tema1/img-3.png' class="w-lg-50" alt='')
          .tarjeta.color-secundario--borde
            .p-4
