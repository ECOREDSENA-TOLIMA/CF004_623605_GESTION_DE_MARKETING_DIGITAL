  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 <em>Marketing</em> digital y de contenidos

    p Al implementar estrategias de <em>marketing,</em> enfocadas en la virtualidad, el <em>buyer</em> personas y los <em>leads;</em> es indispensable, tener claro que es el <em>marketing</em> digital y el <em>marketing</em> de contenido; conceptos que suelen confundirse o creer que trata de lo mismo.  
            ...
            .col-lg-7
              ul.lista-ul.mb-3
                li.mb-0
                  ...
                  | <em>Search Engine Optimization</em> (SEO) o posicionamiento en buscadores. 
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | <em>Search Engine Marketing (SEM) o Marketing</em> en buscadores. 
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | Video <em>Marketing.</em> 
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | <em>E-mail de Marketing.</em>
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | <em>Marketing</em> de influencers. 
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-primario.p-5(style="background-color:#E3ECF7")
        ...
        h3 Temática
        p Identificar la temática del contenido digital: en esta etapa ya se debe tener en cuenta cual es el <em>buyer</em> personas, y el mensaje que se desea transmitir.
      ...
      .col-md.tarjeta.color-acento-botones.p-5(style="background-color:#FFFBE5")
        ...
        h3(style="color:#000") Frecuencia y cantidad
        p(style="color:#000") Identificar la frecuencia y cantidad de publicaciones; para ello se debe trazar una meta anual de cuánto contenido se creará, frecuencia de publicación, teniendo en cuenta el comportamiento de los consumidores en las plataformas, es decir, en qué momento están más aptos para recibir este contenido. 

      .col-md.tarjeta.color-acento-contenido.p-5(style="background-color:#E8E8E8")
        .row.justify-content-center.mb-4
          .col-5
            figure
        ...
        h3 Cronograma
        p Establecer un cronograma que soporte las publicaciones del contenido digital y las actividades a adelantar.

      .col-md.tarjeta.color-acento-contenido.p-5(style="background-color:#E4FDFB")
        .row.justify-content-center.mb-4
          .col-5
            figure
        ...
        h3 Etiquetas
        p Identificar las etiquetas que se encuentren en tendencia y estén acorde con la estrategia de contenido digital.

    .row.justify-content-center.align-items-center.mb-3
      .col-10(data-aos="fade-down-right")
        p.mb-4 Para elegir la temática de contenido digital se debe tener en cuenta el plan de <em>marketing</em> de la organización, el cual traza los objetivos que se pretenden alcanzar; por lo cual la creación del contenido digital debe responder o ir acorde a estos objetivos ya planteados.
    ...
    .row.justify-content-center.mb-5.mt-5
      .col-xl-3.col-lg-7.col-md-9.col-11.mb-4.mb-xl-0
        .tarjetas-up(@mouseover="mostrarIndicador = false")
          ...
          .tarjetas-up_card.p-xl-4.p-lg-3.p-4(style="background-color: #E3ECF7")
          ...
          .tarjetas-up_card.p-xl-4.p-lg-3.p-4(style="background-color: #E3ECF7")
            .title.d-flex.align-items-center.mb-xl-5.mb-lg-4.mb-md-5.mb-4
              span
                i.fas.fa-chevron-circle-up.fa-2x.me-3(style="color:#983333") 
                i.fas.fa-chevron-circle-down.fa-2x.me-3(style="color:#983333")
              h5.mb-0 <strong>El conflicto</strong>
            p.mb-0.text-small Es lo que motiva a la audiencia y en muchos casos se identifica con el público objetivo.

    .row.justify-content-center.align-items-center.mb-4
      .col-10(data-aos="fade-down-right")
        .tarjeta.tarjeta.p-4.mt-4(style="background: linear-gradient(0deg,#ffff, #ffff)")(data-aos="flip-up")
          .row.justify-content-center.align-items-center 
            .col-lg-5.mb-3
              figure(data-aos="fade-right")
                img(src='@/assets/curso/temas/tema3/decorador-2.svg', alt='Texto que describa la imagen')
            .col-lg-6
              p Para crear un <em>storytelling,</em> se debe tener en cuenta las siguientes pautas:
              ul.lista-ul.mb-3
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | Identificar la audiencia o público objetivo. 
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
      ...
      .col-10(data-aos="fade-down-right")
        ...
        ImagenInfografica.color-acento-botones.mb-5.desktop
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/temas/tema3/img-16-1.svg', alt='Texto que describa la imagen')

          .tarjeta.color-acento-botones.p-3(x="50%" y="12%" numero="1")(style="background-color:#EAD6D6")
            p(style="color:#000") En este punto se presenta lo que va a ser la historia, los personajes y el ambiente.

          .tarjeta.color-acento-botones.p-3(x="29%" y="40%" numero="2")(style="background-color:#EAD6D6")
            p(style="color:#000") Se presenta en talles lo que será la historia.

          .tarjeta.color-acento-botones.p-3(x="71%" y="40%" numero="3")(style="background-color:#EAD6D6")
            p(style="color:#000") Se presenta toda la historia junto con los personajes protagonistas, los cuales pueden ser una persona, producto o marca. 

          .tarjeta.color-acento-botones.p-3(x="27%" y="69.5%" numero="4")(style="background-color:#EAD6D6")
            p(style="color:#000") En este punto termina la representación o narración de la historia.
          
          .tarjeta.color-acento-botones.p-3(x="73%" y="69.5%" numero="5")(style="background-color:#EAD6D6")
            p(style="color:#000") Se emplea para dejar en mente lo positivo en el consumidor.
    ...
    p.mb-5 El <em>Search Engine Optimization</em> (SEO) o en el idioma español optimización para motores de búsqueda y <em>Search Engine Marketing</em> (SEM) o en el idioma español <em>marketing</em> en motores de búsqueda; son estrategias de <em>marketing</em> digital, las cuales el canal o medio digital son los buscadores.
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-10(data-aos="fade-down-right")
        ...
        .tarjeta.tarjeta.p-4.mt-4.mb-4(style="background: linear-gradient(0deg,#FFFBE5, #FFFBE5)")(data-aos="flip-up")
          .row.justify-content-center.align-items-center
            .col-lg-4.mb-3
              figure(data-aos="fade-right")
                img(src='@/assets/curso/temas/tema3/decorador-3.svg', alt='Texto que describa la imagen')
            .col-lg-7
              p Algunas de las ventajas del <em>Search Engine Optimization</em> (SEO), son: 
              ul.lista-ul.mb-3
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-10(data-aos="fade-down-right")
        .tarjeta.tarjeta.p-4.mt-4.mb-4(style="background: linear-gradient(0deg,#E3ECF7, #EEF5FF)")(data-aos="flip-up")
          .row.justify-content-center.align-items-center
            .col-lg-4.mb-3
              figure(data-aos="fade-right")
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-lg-7
              ul.lista-ul.mb-3
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | Establecer los objetivos del plan de comunicación digital.
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | Identificar o caracterizar el público objetivo, dentro de este plan de comunicación se deben incluir los usuarios internos, en este caso colaboradores o proveedores de la organización, y los usuarios o consumidores externos. 
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                ...
                li.mb-0
                  i.fas.fa-circle(style="color:#707070")
                  | Seguimiento y evaluación del plan de comunicación digital. 
...
export default {
  ...
  data: () => ({
    datosSlyder: [
      ...
      {
        titulo: 'Búsqueda por información',
        texto:
          'En cuanto a la búsqueda por información, los consumidores mediante los motores de búsqueda solicitan información de un tema en específico, el no reconoce la página web por lo cual se guía por las sugerencias del motor de búsqueda. <br><br> Por ejemplo, buscar una institución de educación superior, muestra la página del Ministerio de Educación.',
        imagen: require('@/assets/curso/temas/tema3/img-19.png'),
      },
      {
        titulo: 'Búsqueda local',
        texto:
          'Y en cuanto a la búsqueda transaccional, se refiere a la compra que va a realizar el consumidor por lo cual se denomina transacción, también existen las búsquedas locales, referentes a una ubicación geográfica; como puede ser un establecimiento público o una ciudad. <br><br> Por ejemplo, Autolavados en Bogotá.',
